...
@Component({
  selector: 'app-approve-team-user',
  templateUrl: './approve-team-user.component.html',
  styleUrls: ['./approve-team-user.component.css']
})
export class ApproveTeamUserComponent implements OnInit {
